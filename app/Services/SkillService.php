    ...
    **********************************************************************************************/
    ...
    public function createSkillCategory($data, $user) {
        ...
        try {
            ...
            if (!$this->logAdminAction($user, 'Created Skill Category', 'Created '.$category->displayName)) {
    ...
    public function updateSkillCategory($category, $data, $user) {
        ...
        try {
            ...
            if (!$this->logAdminAction($user, 'Updated Skill Category', 'Updated '.$category->displayName)) {
                throw new \Exception('Failed to log admin action.');
            }
    ...
    **********************************************************************************************/
    ...
    public function createSkill($data, $user) {
        ...
        try {
            ...
            if (!$this->logAdminAction($user, 'Created Skill', 'Created '.$skill->displayName)) {
                throw new \Exception('Failed to log admin action.');
            }
    ...
    public function updateSkill($skill, $data, $user) {
        ...
        try {
            ...
            $skill->update($data);
            if (!$this->logAdminAction($user, 'Updated Skill', 'Updated '.$skill->displayName)) {
                throw new \Exception('Failed to log admin action.');
            }
