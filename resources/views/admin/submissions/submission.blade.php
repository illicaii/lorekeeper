        ...
        <div id="characterComponents" class="hide">
            ...
            <table>
                <tr class="character-reward-row">
                    ...
                    @if ($expanded_rewards)
                        <td>
                            {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'SkillGrant' => 'Skill Grant', 'SkillXP' => 'Skill XP', 'SkillLevel' => 'Skill Level'], null, [
