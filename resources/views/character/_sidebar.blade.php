<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/skill-abilities' }}" class="{{ set_active('character/' . $character->slug . '/skill-abilities') }}">Abilities</a></div>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/skill-ability-logs' }}" class="{{ set_active('character/' . $character->slug . '/skill-ability-logs') }}">Ability Logs</a></div>
